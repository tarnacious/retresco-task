...
class Analytics:
    ...
    def __init__(self, article_views):

        self.article_views = article_views
        self.keybuilder = KeyBuilder()
        self.storage = article_views.storage
    ...
    def date_range_views(self, start_date, end_date):
...
class ArticleViews:
    ...
    def article_date_range_views(self, document_name, start_date, end_date):
